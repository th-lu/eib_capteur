...
public class SignalTools {
	...
	static private AbstractList<Double> FFT(AbstractList<Double> values, int n) {// size of values is 2*n : 0->(n-1)=
																					// real part; n->(2n-1)=imaginary
																					// part
		if (n == 1)
			return values;
	...
	static private Double Module(Double re, Double im) {
		return Math.sqrt(re * re + im * im);
	}

	static private Double Phase(Double re, Double im) {
